...
- Implement one public user/operator Skill at `skills/openkit/`; admit real-use product acceptance while keeping SSH/source development outside the CLI; do not create developer, self-improvement, setup-only, or loop-only variants.
