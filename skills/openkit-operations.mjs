...
export const operationCatalog = [
  ...
  },
  {
    ...
    mutating: false,
    inputSchema: EMPTY_INPUT,
    handler: ({ client }, input) => client.app.listServerVaultUseRecords(),
  },
  {
    ...STANDARD,
    id: 'catalog.read',
    source: 'app-api',
    appOperationId: 'getWorkspaceCatalog',
    clientMethod: 'catalog.get',
    group: 'catalog',
    summary: 'Read the Workspace Skill, MCP, and plugin catalog summary.',
    mutating: false,
    inputSchema: strictScope(workspaceScope),
    handler: ({ client }, input) => client.catalog.get(input.workspaceId),
  },
  {
    ...STANDARD,
    id: 'catalog.skill-list',
    source: 'app-api',
    appOperationId: 'listSkillCatalog',
    clientMethod: 'catalog.listSkills',
    group: 'catalog',
    summary: 'List Workspace Skill catalog entries.',
    mutating: false,
    inputSchema: strictScope(workspaceScope),
    handler: ({ client }, input) => client.catalog.listSkills(input.workspaceId),
  },
  {
    ...STANDARD,
    id: 'catalog.skill-import',
    source: 'app-api',
    appOperationId: 'importSkill',
    clientMethod: 'catalog.importSkill',
    group: 'catalog',
    summary: 'Import one Skill tree into the Workspace catalog.',
    mutating: true,
    inputSchema: flatRequest(appSchemas.ImportSkillRequestSchema, workspaceScope),
    handler: ({ client }, input) =>
      client.catalog.importSkill(input.workspaceId, bodyWithout(input, 'workspaceId')),
  },
  {
    ...STANDARD,
    id: 'catalog.skill-candidate-submit',
    source: 'app-api',
    appOperationId: 'submitSkillCandidate',
    clientMethod: 'catalog.submitSkillCandidate',
    group: 'catalog',
    summary: 'Submit one Skill candidate without changing the current pointer.',
    mutating: true,
    inputSchema: flatRequest(appSchemas.SubmitSkillCandidateRequestSchema, {
      ...workspaceScope,
      skillId: IDENTIFIER,
    }),
    handler: ({ client }, input) =>
      client.catalog.submitSkillCandidate(
        input.workspaceId,
        input.skillId,
        bodyWithout(input, 'workspaceId', 'skillId')
      ),
  },
  {
    ...STANDARD,
    id: 'catalog.skill-candidate-decide',
    source: 'app-api',
    appOperationId: 'decideSkillCandidate',
    clientMethod: 'catalog.decideSkillCandidate',
    group: 'catalog',
    summary: 'Promote, reject, or withdraw one Skill candidate.',
    mutating: true,
    inputSchema: flatRequest(appSchemas.DecideSkillCandidateRequestSchema, {
      ...workspaceScope,
      candidateId: IDENTIFIER,
    }),
    handler: ({ client }, input) =>
      client.catalog.decideSkillCandidate(
        input.workspaceId,
        input.candidateId,
        bodyWithout(input, 'workspaceId', 'candidateId')
      ),
  },
  {
    ...STANDARD,
    id: 'catalog.skill-select',
    source: 'app-api',
    appOperationId: 'selectSkillDefault',
    clientMethod: 'catalog.selectSkillDefault',
    group: 'catalog',
    summary: 'Select the current Skill default digest.',
    mutating: true,
    inputSchema: flatRequest(appSchemas.SelectSkillVersionRequestSchema, {
      ...workspaceScope,
      skillId: IDENTIFIER,
    }),
    handler: ({ client }, input) =>
      client.catalog.selectSkillDefault(
        input.workspaceId,
        input.skillId,
        bodyWithout(input, 'workspaceId', 'skillId')
      ),
  ...
  {
    ...STANDARD,
    id: 'catalog.skill-pin',
    source: 'app-api',
    appOperationId: 'setSkillPin',
    clientMethod: 'catalog.setSkillPin',
    group: 'catalog',
  ...
  },
  {
    ...
    id: 'catalog.mcp-list',
    source: 'app-api',
    appOperationId: 'listMcpCatalog',
    clientMethod: 'catalog.listMcp',
    group: 'catalog',
    summary: 'List Workspace MCP catalog entries.',
    mutating: false,
    inputSchema: strictScope(workspaceScope),
    handler: ({ client }, input) => client.catalog.listMcp(input.workspaceId),
  },
  {
    ...STANDARD,
    id: 'catalog.mcp-create',
    source: 'app-api',
    appOperationId: 'createMcpConfig',
    clientMethod: 'catalog.createMcpConfig',
    group: 'catalog',
    summary: 'Create an inactive MCP configuration version.',
    mutating: true,
    inputSchema: flatRequest(appSchemas.CreateMcpConfigRequestSchema, workspaceScope),
    handler: ({ client }, input) =>
      client.catalog.createMcpConfig(input.workspaceId, bodyWithout(input, 'workspaceId')),
  },
  {
    ...STANDARD,
    id: 'catalog.mcp-select',
    source: 'app-api',
    appOperationId: 'selectMcpVersion',
    clientMethod: 'catalog.selectMcpVersion',
    group: 'catalog',
    summary: 'Select the current MCP configuration version.',
    mutating: true,
    inputSchema: flatRequest(appSchemas.SelectMcpVersionRequestSchema, {
      ...workspaceScope,
      mcpId: IDENTIFIER,
    }),
    handler: ({ client }, input) =>
      client.catalog.selectMcpVersion(
        input.workspaceId,
        input.mcpId,
        bodyWithout(input, 'workspaceId', 'mcpId')
      ),
  },
  {
    ...STANDARD,
    id: 'catalog.mcp-binding',
    source: 'app-api',
  ...
  {
    ...STANDARD,
    id: 'catalog.plugin-list',
    source: 'app-api',
    appOperationId: 'listPluginCatalog',
    clientMethod: 'catalog.listPlugins',
    group: 'catalog',
    summary: 'List Workspace Agent Plugin catalog entries.',
    mutating: false,
    inputSchema: strictScope(workspaceScope),
    handler: ({ client }, input) => client.catalog.listPlugins(input.workspaceId),
  },
  {
    ...STANDARD,
    id: 'catalog.plugin-import',
    source: 'app-api',
    appOperationId: 'importPlugin',
    clientMethod: 'catalog.importPlugin',
    group: 'catalog',
    summary: 'Import one Agent Plugin package into the Workspace catalog.',
    mutating: true,
    inputSchema: flatRequest(appSchemas.ImportPluginRequestSchema, workspaceScope),
    handler: ({ client }, input) =>
      client.catalog.importPlugin(input.workspaceId, bodyWithout(input, 'workspaceId')),
  },
  {
    ...STANDARD,
    id: 'repository.list',
