...
- `docs/specs/20260910-app_update_delivery.md` — Accepted, Not Started — This specification owns explicitly administrator-directed NanoCore and Web replacement on one configured deployment: the bounded public update command, process…
