...
- `docs/specs/20260731-operational_telemetry_standardization.md` — Accepted, Not Started — The non-authoritative operational telemetry projection for OpenKit runtime and repository-test execution.
...
- `docs/specs/20260909-persistent_deployment_acceptance.md` — Accepted, Not Started — This specification owns ordinary functional acceptance on a persistent internal OpenKit deployment: the composition of in-product work and external Skill-drive…
