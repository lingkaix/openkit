...
- `docs/specs/20260908-generative_kernel_data_operations.md` — Accepted, Not Started — This specification owns each Light App's stable schema and data implementation: file-authored definitions, one app SQLite database, semantic discovery, general…
- `docs/specs/20260908-generative_ui_interaction.md` — Accepted, Not Started — This specification owns agent-native declarative presentation and interaction across temporary and reusable surfaces: admission, source binding, action dispatc…
