...
| --- | --- | --- | --- |
| GitHub Smart HTTP read (`github-git-read`) | `github.com:443` | `GET /**/info/refs*` and `POST /**/git-upload-pack` | `/usr/bin/git`, projected with `/usr/lib/git-core/git-remote-http` and `/usr/lib/git-core/git-remote-https` |
