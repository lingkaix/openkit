...
The current implementation satisfies the closed V1 protocol semantics and implements the private multi-Harness transport topology inside the existing version 1 envelopes. The accepted version 2 envelope literal below and refreshed real-host and fault-acceptance evidence remain unimplemented:
