...
Superseded by `docs/specs/20260703-workspace_synchronization.md`, `docs/specs/20260703-agent_manifest_aep_resolution.md`, and `docs/specs/20260703-storage_layout_record_ownership.md`.

This document is retained as supporting detail for the early host-local mount design. Active workspace input, materialization, output collection, staged review, and apply behavior is owned by the workspace synchronization spec.
