...
Superseded by `docs/specs/20260629-worker_runtime_communication_model.md`, `docs/specs/20260703-worker_control_protocol.md`, `docs/specs/20260703-worker_agent_capability.md`, and `docs/specs/20260703-workspace_synchronization.md`.

This document is an implementation-layer spec for Codex-style agent communication modes.

The stable core and deployment guidance lives in `docs/core/communication.md`, `docs/deployment.md`, `docs/core/runtime-model.md`, and `docs/specs/20260629-worker_runtime_communication_model.md`. This superseded spec is retained as historical design context and must not be used as the current runtime contract.
