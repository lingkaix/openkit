...
Superseded by `docs/specs/20260529-test_strategy.md`, `docs/specs/20260529-l6_story_acceptance.md`, and the current worker-runtime specs.

This document is retained as supporting detail for the original deterministic simulator implementation slice.
