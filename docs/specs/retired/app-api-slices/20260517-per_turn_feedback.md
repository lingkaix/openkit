...
Superseded by `docs/specs/20260703-audit_usage_evidence_records.md`, `docs/specs/20260628-web_product_surface_projection.md`, and the current App API implementation projection.

This document is retained as supporting detail for the original per-turn feedback implementation slice.
