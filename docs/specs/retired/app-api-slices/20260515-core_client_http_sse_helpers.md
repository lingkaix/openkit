...
Superseded by `docs/specs/20260528-core_client_boundary.md`.

This document is retained as supporting detail for the original HTTP and SSE helper implementation slice.
