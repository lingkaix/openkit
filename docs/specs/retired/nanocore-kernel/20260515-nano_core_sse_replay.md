...
Superseded by `docs/specs/20260628-protocol_contract_consolidation.md`, `docs/specs/20260629-worker_runtime_communication_model.md`, and `docs/specs/20260528-core_client_boundary.md`.

This document is retained as supporting detail for the original turn SSE replay implementation slice.
