...
Superseded by `docs/core/agent-workflow.md`, `docs/specs/20260627-openkit_development_loop_protocol.md`, `docs/specs/20260531-worker_turn_reliability_envelope.md`, `docs/specs/20260703-runtime_scheduling_scale.md`, and `docs/specs/20260703-worker_context_package.md`.

This document is retained as supporting detail for long-running workflow research. The current contract describes composable Agent Workflow mechanisms and default Goal Mode loops instead of promoting Sustained Mode as a separate active root spec.
