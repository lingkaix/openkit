...
Superseded by `docs/core/agent-workflow.md`, `docs/specs/20260531-worker_turn_reliability_envelope.md`, `docs/specs/20260629-worker_runtime_communication_model.md`, and `docs/specs/20260703-runtime_scheduling_scale.md`.

This document is retained as supporting detail for the original route-level turn-orchestrator implementation slice.
