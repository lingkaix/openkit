...
Superseded by `docs/specs/20260628-nanocore_config_identity_contract.md`.

This document is retained as supporting detail for the original mode-resolution implementation slice.
