...
The following first-party evidence was checked on 2026-09-02 against then-pinned Pi `0.80.7` and OpenCode `1.18.1`. The Pi row was re-checked on 2026-09-05 against then-current worker pin `0.85.0` at exact tag `v0.85.0` commit `107d79f11072bbc8a3a757ed7fd69596bee7d68c`, and again on 2026-09-06 against the current worker pin `0.85.1` at exact tag `v0.85.1` commit `d981de1229ef899957bbe968bc8dcda02a21f477`. External projects inform this design but do not own it.
