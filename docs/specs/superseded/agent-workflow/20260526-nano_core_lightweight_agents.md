...
current-guidance: "`docs/core/architecture.md`, `docs/core/agent-workflow.md`, `docs/specs/20260531-worker_turn_reliability_envelope.md`, `docs/specs/20260703-worker_context_package.md`"
decision-evidence: "`docs/core/architecture.md`, `docs/core/agent-workflow.md`, `docs/specs/20260531-worker_turn_reliability_envelope.md`, `docs/specs/20260703-worker_context_package.md`"
---
# NanoCore Lightweight Agents

## Lifecycle Reason

Core Architecture, Agent Workflow, reliability, and context-package guidance absorbed the internal coordination roles and their execution boundaries. The lightweight-agents document lost authority because role ownership now belongs to the stable Core model and dedicated role specs rather than one combined exploratory design.

## Retention Reason

This document preserves the early role decomposition, coordination alternatives, and lightweight-runtime constraints so maintainers can trace the origin of current internal roles without reviving a parallel role catalog.
...
The future full loop supporting detail lives in `docs/specs/superseded/agent-workflow/20260525-sustained_mode_long_running_agent.md`.
...
- `docs/specs/superseded/agent-workflow/20260525-sustained_mode_long_running_agent.md`
