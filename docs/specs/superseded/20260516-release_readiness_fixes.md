...
Amendment 2026-05-29: The `ApiErrorSchema` default described below is superseded by [Remove Historical Compatibility Layers](./20260529-remove_legacy_compatibility.md). Current API error payloads must carry explicit `protocolVersion`, and validators reject missing versions.
