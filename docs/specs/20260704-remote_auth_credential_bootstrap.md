...
- Current middleware preserves deployment administration while requiring `server-admin` actors to pass the same active Workspace membership and policy checks as every other actor before accessing Workspace content.
