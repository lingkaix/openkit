...
- `apps/nanocore/src/internal-agents/modes.ts`, `tools.ts`, and delegation code include a `knowledge-manager` internal-agent mode, knowledge search, and knowledge proposal drafting tools.
