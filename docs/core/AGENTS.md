...
- Resolve stable decisions directly in core text; move unresolved or implementation-facing questions to specs, change records, roadmap, or uncommitted working space.
