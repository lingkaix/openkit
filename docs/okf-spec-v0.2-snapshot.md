# OKF Specification v0.2 — Pinned Snapshot

- Snapshot kind: external format specification snapshot (verbatim)
- Upstream source: https://github.com/GoogleCloudPlatform/open-knowledge-format/blob/ad30107c31c06aec8a7d5636e0d1058118604e6f/SPEC.md
- Upstream commit: `ad30107c31c06aec8a7d5636e0d1058118604e6f`
- Captured: 2026-09-06
- Upstream declared version: 0.2
- Pinned by: `docs/specs/20260703-knowledge_store_implementation.md`

OpenKit conformance uses this immutable snapshot. Live upstream changes have no effect until an explicit pin update. The previous v0.1 snapshot remains historical evidence.
