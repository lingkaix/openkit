# OKF Specification v0.1 — Pinned Snapshot

- Snapshot kind: external format specification snapshot (verbatim)
- Upstream source: https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md
- Upstream raw URL: https://raw.githubusercontent.com/GoogleCloudPlatform/knowledge-catalog/main/okf/SPEC.md
- Captured: 2026-07-03
- Upstream declared version: 0.1 (Draft)
- Pinned by: `docs/specs/20260703-knowledge_store_implementation.md`

OpenKit pins the Open Knowledge Format at version 0.1 as captured below. This snapshot is the normative OKF text for all OpenKit conformance decisions. The live upstream document MUST NOT be treated as OpenKit guidance. Adopting a newer OKF revision requires a deliberate spec update that references a new dated snapshot; this file itself must never be edited except to fix transcription errors against the captured source.

Everything below this line is the verbatim upstream content.
