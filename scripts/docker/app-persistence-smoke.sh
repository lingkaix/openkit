...
write_persistence_markers() {
  ...
  local workspace_root="${data_root}/workspaces/${workspace_id}"
...
assert_data_root_layout() {
  ...
  assert_directory_exists "${workspace_root}/logs" "data-root workspaces/${workspace_id}/logs"
  assert_directory_exists "${workspace_root}/artifacts" "data-root workspaces/${workspace_id}/artifacts"
  assert_directory_exists "${workspace_root}/knowledge" "data-root workspaces/${workspace_id}/knowledge"
  assert_directory_exists "${workspace_root}/sources" "data-root workspaces/${workspace_id}/sources"
  assert_directory_exists "${workspace_root}/threads" "data-root workspaces/${workspace_id}/threads"
  assert_directory_exists "${workspace_root}/runtime" "data-root workspaces/${workspace_id}/runtime"
  assert_directory_exists "${workspace_root}/reviews" "data-root workspaces/${workspace_id}/reviews"
  assert_directory_exists "${workspace_root}/evidence" "data-root workspaces/${workspace_id}/evidence"
  assert_directory_exists "${workspace_root}/indexes" "data-root workspaces/${workspace_id}/indexes"
