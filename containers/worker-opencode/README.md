...
This image packages the shared OpenKit development environment, its inherited persistent `/workspace` and `/sandbox` layout, the generic worker shim, the static OpenCode adapter, and `opencode-ai@1.18.1` for governed OpenShell execution.
