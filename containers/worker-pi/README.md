...
This image packages the shared OpenKit development environment, the generic worker shim, the static Pi adapter, and `@earendil-works/pi-coding-agent@0.80.7` for governed OpenShell execution.
