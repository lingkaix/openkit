...
This directory owns the repository's declarative A1 host identity and the smallest scripts that provision, assert, observe NanoHost readiness, and tear down one real-use attempt.
