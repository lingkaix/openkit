...
src/
  ...
  screens/
    ...
    settings/         Tier-A General, Configuration, read-only Workspace Vault, Usage & audit, and Debug; unpublished AI interface review screen
